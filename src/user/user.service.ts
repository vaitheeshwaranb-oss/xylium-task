...
export class UserService {
  constructor(
    ...
    private readonly userDetailsModel: Model<UserDetailDocument>,
  ...
  async createUserDetails(
    createUserDetailDto: UserDetailDto,
  ...
  async fetchByIdUserDetails(id: ObjectId): Promise<ResponseInterface> {
    const userDetail = await this.userDetailsModel
      .findOne({ user_id: id }, 'gender location, user_id')
      .exec();
